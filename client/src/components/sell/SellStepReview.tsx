import { Tag, Heart, Clock, Package } from 'lucide-react'
...
export default function SellStepReview({ form, mode = 'sell' }: SellStepReviewProps) {
    ...
    <div className={styles.review}>
      ...
      {mode === 'sell' && (
        <div className={styles.section}>
          ...
          <div className={styles.sectionContent}>
            <p className={styles.sectionLabel}>Auction</p>
            <p className={styles.detail}>2-hour auction</p>
            <p className={styles.detail}>
              Starting price: <strong>{formatPrice(parseFloat(form.startingPrice) || 0)}</strong>
            </p>
          </div>
        </div>
      )}
      ...
      <div className={styles.section}>
        ...
        <div className={styles.sectionContent}>
          <p className={styles.sectionLabel}>Charity</p>
          {charity ? (
            <>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.sectionContent}>
          ...
          {form.dropOff ? (
            <p className={styles.detail}>Drop-off by seller</p>
          ) : form.pickupDay ? (
            <>
              <p className={styles.detail}>
